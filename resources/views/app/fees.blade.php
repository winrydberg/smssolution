            ...
            <div class="statement_content">
               ...
               @if(count($fees) >0)
                    <div class="alert alert-info d-flex flex-column align-items-center">
                        ...
                        <p class="">Fees for the current academic year {{env("ACADEMIC_YEAR")}}</p>
                    </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <strong style="color:red;">Entering fee for {{env("ACADEMIC_YEAR")}}</strong>
              <form id="class_subject_form" @submit.prevent="saveFee">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class=" mt-20">
                            <label>Applies On <span style="color:red;">*</span></label>
                            <select class="selectpicker mt-2 " @change="getRemoteData" required v-model="form.applies_on" name="term">
                    ...
                    <div class="col-md-12" v-show="form.applies_on == 'CLASS'">
                        <div class=" mt-20">
                            <label>Class <span style="color:red;">*</span></label>
                            <select class="selectpicker mt-2" v-model="form.classes" name="classes" multiple>
                                <option value="" disabled>Select an option</option>
